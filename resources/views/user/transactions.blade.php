...
@section('content')
    ...
    <div class="grid grid-cols-3 gap-6">
        ...
        <a href="{{ route('showDetailTransaction', ['id' => $item->id]) }}">
            <div class="gap-4">
                <table class="bg-primary-800 hover:bg-primary-600 transition-all duration-500 hover rounded-lg mx-auto w-full">
                    <tr">
